function Get-GitStatuses {
    <#
    .SYNOPSIS
        Git Status Scanner - Displays status information for all Git repositories in the specified directory
    
    .DESCRIPTION
        This function scans the specified directory for Git repositories and displays a table with:
        - Repository name
        - Remote URL
        - Branch name
    ...
    .PARAMETER Path
        The path to scan for Git repositories. Defaults to current directory.
    
    .PARAMETER Detailed
        Show detailed information including remote URLs and total commits.
    ...
    .EXAMPLE
        Get-GitStatuses -Path "C:\Projects" -Detailed
        Scans C:\Projects directory and displays detailed git status for all repositories
    #>
